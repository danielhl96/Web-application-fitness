...
const _mealscontroller = require("./meals.controller");
...
describe('MealsController', ()=>{
    ...
    beforeEach(async ()=>{
        const module = await _testing.Test.createTestingModule({
            controllers: [
                _mealscontroller.MealsController
            ],
            providers: [
                {
                    provide: _mealsservice.MealsService,
                    useValue: {
                        createMeal: jest.fn().mockResolvedValue(mockMeal),
                        deleteMeal: jest.fn().mockResolvedValue({
                            message: 'Meal deleted successfully'
                        }),
                        editMeal: jest.fn().mockResolvedValue(mockMeal),
                        getBreakfast: jest.fn().mockResolvedValue([
                            mockMeal
                        ]),
                        getLunch: jest.fn().mockResolvedValue([
                            mockMeal
                        ]),
                        getDinner: jest.fn().mockResolvedValue([
                            mockMeal
                        ]),
                        getSnack: jest.fn().mockResolvedValue([
                            mockMeal
                        ]),
                        calculateMeal: jest.fn().mockResolvedValue({
                            calories: 300
                        }),
        ...
        controller = module.get(_mealscontroller.MealsController);
        mealsService = module.get(_mealsservice.MealsService);
    });
    // ── POST /meals ────────────────────────────────────────────────────────────
    describe('createMeal', ()=>{
        it('should create a meal and return it', async ()=>{
            ...
            const result = await controller.createMeal(mockRequest(), dto);
    ...
    describe('deleteMeal', ()=>{
        it('should delete a meal and return success message', async ()=>{
            const result = await controller.deleteMeal(mockRequest(), '1');
    ...
    describe('editMeal', ()=>{
        it('should edit a meal and return updated meal', async ()=>{
            ...
            const result = await controller.editMeal(mockRequest(), '1', body);
            expect(mealsService.editMeal).toHaveBeenCalledWith({
                ...body,
                mealId: 1
            }, mockUser.id);
            expect(result).toEqual(mockMeal);
    ...
    describe('getMeals', ()=>{
        it('should return breakfast meals', async ()=>{
            const result = await controller.getMeals(mockRequest(), 'breakfast', '2026-06-03');
        ...
        it('should return lunch meals', async ()=>{
            const result = await controller.getMeals(mockRequest(), 'lunch', '2026-06-03');
        ...
        it('should return dinner meals', async ()=>{
            const result = await controller.getMeals(mockRequest(), 'dinner', '2026-06-03');
        ...
        it('should return snack meals', async ()=>{
            const result = await controller.getMeals(mockRequest(), 'snack', '2026-06-03');
        ...
        it('should throw NotFoundException for invalid meal type', async ()=>{
            await expect(controller.getMeals(mockRequest(), 'invalid', '2026-06-03')).rejects.toThrow(_common.NotFoundException);
        });
    });
...
describe('CreateMealDto', ()=>{
    ...
    it('should pass with all required fields', async ()=>{
        const dto = (0, _classtransformer.plainToInstance)(_meals_dto.CreateMealDto, validBase);
        const errors = await (0, _classvalidator.validate)(dto);
        expect(errors).toHaveLength(0);
    });
    it('should pass with optional date provided', async ()=>{
        const dto = (0, _classtransformer.plainToInstance)(_meals_dto.CreateMealDto, {
            ...validBase,
            date: '2026-06-03'
        });
        const errors = await (0, _classvalidator.validate)(dto);
    ...
    it('should fail when name is missing', async ()=>{
        ...
        const dto = (0, _classtransformer.plainToInstance)(_meals_dto.CreateMealDto, rest);
        const errors = await (0, _classvalidator.validate)(dto);
...
describe('EditMealDto', ()=>{
    ...
    it('should pass with all required fields', async ()=>{
        const dto = (0, _classtransformer.plainToInstance)(_meals_dto.EditMealDto, validBase);
        const errors = await (0, _classvalidator.validate)(dto);
        expect(errors).toHaveLength(0);
    });
    it('should fail when mealId is missing', async ()=>{
        const { mealId, ...rest } = validBase;
        const dto = (0, _classtransformer.plainToInstance)(_meals_dto.EditMealDto, rest);
        const errors = await (0, _classvalidator.validate)(dto);
    ...
    it('should fail when mealId is a string instead of number', async ()=>{
        const dto = (0, _classtransformer.plainToInstance)(_meals_dto.EditMealDto, {
            ...validBase,
            mealId: 'abc'
        });
        const errors = await (0, _classvalidator.validate)(dto);
