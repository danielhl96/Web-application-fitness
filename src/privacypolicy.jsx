        ...
        <div className="overflow-auto max-h-[80vh] text-white">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              Kontaktdaten können Sie dem Abschnitt{' '}
              <span className="font-semibold">„Hinweis zur Verantwortlichen Stelle“</span> in dieser
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>
                ...
                durch unsere IT-Systeme erfasst (z.&nbsp;B. Internetbrowser, Betriebssystem, Uhrzeit
                des Seitenaufrufs).
              </li>
            </ul>
            ...
            <h4 className="font-semibold mb-1">Welche Rechte haben Sie bezüglich Ihrer Daten?</h4>
            <ul className="list-disc pl-6 mb-4">
              <li>
          ...
          {/* Abschnitt 2 */}
          <section className="mb-8">
            <h2 className="text-xl font-bold mb-3 border-b border-blue-300 pb-1">2. Hosting</h2>
            ...
            <p className="mb-4">
              ...
              von Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG, soweit die Einwilligung die
              Speicherung von Cookies oder den Zugriff auf Informationen im Endgerät des Nutzers
              umfasst. Die Einwilligung ist jederzeit widerrufbar.
            </p>
            <p className="mb-4">
              Unser(e) Hoster wird Ihre Daten nur insoweit verarbeiten, wie dies zur Erfüllung
              seiner Leistungspflichten erforderlich ist und unsere Weisungen in Bezug auf diese
              Daten befolgen.
            </p>
            <div className="mb-4">
              <span className="font-semibold">Wir setzen folgenden Hoster ein:</span>
