...
function PrivacyPolicy() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-900 mt-16">
      <Header />
      <div className="space-y-4 card sm:w-96 md:w-96 w-96  bg-gray-800 border border-blue-500 shadow-sm p-6 rounded-md">
        ...
        <p>
          Osano International Compliance Services Limited ATTN: 9UOQ 3 Dublin
          Landings North Wall Quay Dublin 1 D01C4E0
        </p>
