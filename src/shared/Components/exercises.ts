const exercise = [
  ...
  },
  {
    ...
    description: 'An exercise to train the core muscles and improve cardiovascular fitness',
    img: './mountainclimbers.png',
  },
  {
    name: 'Burpees',
    description: 'A full-body exercise that improves cardiovascular fitness and strength',
    img: './burpees.png',
  },
  {
    name: 'Leg Raises',
  ...
  },
  {
    ...
    description: 'An exercise to train the upper chest, shoulder, and triceps',
    img: './inclinebenchpress.png',
  },
  {
    name: 'Push-Ups',
    description: 'A bodyweight exercise to train the chest, shoulders, and triceps',
    img: './pushups.png',
  },
  {
    name: 'Hammer Curls',
