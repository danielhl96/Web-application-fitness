...
function ExerciseCard({
  ...
  return (
    <div className="w-60 max-w-xs sm:max-w-sm md:max-w-md flex flex-col items-center mb-4">
      <div
        className={`card w-full ${maximized ? 'h-[40dvh]' : 'h-[18dvh]'} bg-black/20 border border-blue-500 shadow-xl rounded-xl flex flex-col items-center backdrop-blur-lg border-[1px] border-white/20`}
      >
