  ...
  return (
    <div className="min-h-dvh bg-gradient-to-b from-gray-900 to-black flex flex-col items-center px-1 py-3">
      ...
      <div className="flex flex-col items-center sm:items-center  w-full pt-16 pb-8">
        <div className="w-full lg:w-auto max-w-sm sm:max-w-md lg:max-w-4xl space-y-6 rounded-xl bg-black/20 border border-white/20 p-6 sm:p-8 shadow-xl backdrop-blur-lg">
          {children}
        </div>
        {!dockDisabled ? (
          <div
