    ...
    <div>
      <div className="navbar fixed top-0 left-0 w-full bg-black text-white z-50">
        <div className="flex w-full justify-between items-center px-4">
          <Link to="/" className="btn btn-ghost text-white text-lg font-bold">Fitness</Link>
          ...
          <div className={`flex-col md:flex md:flex-row md:items-center md:static absolute top-full left-0 w-full md:w-auto bg-black md:bg-transparent z-40 transition-all duration-200 ${menuOpen ? 'flex' : 'hidden'}`}>
           ...
           <Link to="/counter" className="btn btn-ghost text-white md:ml-4" onClick={() => setMenuOpen(false)}>Counter</Link>
